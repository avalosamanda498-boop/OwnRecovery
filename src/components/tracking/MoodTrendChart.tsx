...
export default function MoodTrendChart({ data, rangeLabel }: MoodTrendChartProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {trendInsight && (
        <div className="rounded-2xl border border-primary-100 bg-primary-50/60 p-4 text-sm text-gray-800">
          <p className="font-medium text-gray-800">Today’s interpretation</p>
          <p className="mt-1 text-gray-800">{trendInsight}</p>
        </div>
      )}
    </div>
  )
